...
var terraformPluginSDKExternalNameConfigs = map[string]config.ExternalName{
	...
	// privileged
	//
	// azuread_privileged_access_group_assignment_schedule can be imported using their ID
	"azuread_privileged_access_group_assignment_schedule": config.IdentifierFromProvider,

	// azuread_privileged_access_group_eligibility_schedule can be imported using their ID
